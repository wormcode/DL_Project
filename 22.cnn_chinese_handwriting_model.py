...
# read the image and correspond Chinese handwriting
...
# get the beginning 140 characters from the common Chinese 
...
# the data is small, you can load all the data to memory at a time
train_data_x = []
train_data_y = []
...
def train_hand_write_cnn():
	...
	with tf.Session() as sess:
		...
		# command: tensorboard --logdir=./log  open browser http://0.0.0.0:6006
