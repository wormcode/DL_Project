...
def convolutional_neural_network(data):
	...
	# dropout: deactivate some of the nurons when training, in reference stage dropout not used.
...
# use 100 items of data each time
batch_size = 100
...
def train_neural_network(X, Y):
	...
	with tf.Session() as session:
		...
		print('accurate: ', accuracy.eval({X:mnist.test.images, Y:mnist.test.labels}))
