		...
		while True:
			for event in pygame.event.get():
				if event.type == QUIT:
					pygame.quit()
					sys.exit()
				elif event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:  # mouse left button down(move left)
					bar_move_left = True
				elif event.type == pygame.MOUSEBUTTONUP and event.button == 1: # release mouse left button
					bar_move_left = False
				elif event.type == pygame.MOUSEBUTTONDOWN and event.button == 3: # mouse right button
					bar_move_right = True
